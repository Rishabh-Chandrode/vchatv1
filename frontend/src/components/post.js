  ...
  return (
    <div className="post">
      <div className="post__header">
        ...
        {post.ProfilePicture?(
                <img src={"http://localhost:5000/images/" + post.ProfilePicture} alt="profile" className="post__header__profilePicture" />
              ):(
                <img
            src={noprofile}
            alt="noprofile"
      ...
      <div className="post__body">
        <div className="post__body__content">
          ...
          <div className="post__body__content__image__container">
            {post.img ? <img crossOrigin="anonymous" src={"http://localhost:5000/images/" + post.img} className="post__body__content__image" alt="post" /> : 
            <img
